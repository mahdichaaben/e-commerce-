User
array:7 [▼ // app\Http\Controllers\CartController.php:20
  0 => array:4 [▼
    "id" => 4
    "name" => "sauvage"
    "price" => "60.00"
  ...
  5 => array:4 [▶]
  6 => array:4 [▶]
] this is the session now iterate it and show thoes variable in this blade <x-app-layout>
    <x-slot name="appname">
        cart shopping
    </x-slot>
    <x-slot name="slot">
              ...
              <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                ...
                <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                  ...
                  <div class="flex justify-between">
                    ...
                    <div class="">
                      <p class="mb-1 text-lg font-bold">$134.98 Dt</p>
